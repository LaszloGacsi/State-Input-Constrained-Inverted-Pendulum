...
Matlab codes for numerical simulation of the inverted pendulum using backup CBF with mixed state-input constraints. See details in our paper below. Please cite the paper if you use these codes for your research.
